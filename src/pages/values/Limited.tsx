  ...
  const items = [
    {
      ...
      category: "Limited",
      status: "Overpaid",
      icon: <img src="https://bloxfruitsvalues.com/_next/image?url=%2Fassets%2Fgamepasses%2FDragon%20Token_Icon.webp&w=256&q=75" alt="Rocket" className="h-24 w-24 mx-auto" />, // Updated to use uploaded image
      value: 450000000,
      demand: "10/10",
    },
    {
